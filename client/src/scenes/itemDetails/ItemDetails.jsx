...
const ItemDetails = () => {
  ...
  async function getItem() {
    const item = await fetch(
      `https://patient-champion-f059357f05.strapiapp.com/api/items/${itemId}?populate=*`,
      { method: "GET" }
    );
  ...
  async function getItems() {
    const items = await fetch(
      "https://patient-champion-f059357f05.strapiapp.com/api/items?populate=*", // '?populate=image' gets images from each of the items along with the items data
      { method: "GET" }
    );
